...
print("\n[REGRESIÓN LOGÍSTICA]:")
print(ranking_lr[['ranking', 'id_cliente', 'score_lr']].head(5).to_string(index=False))
print("\n[KNN]:")
...
plt.savefig('grafica_accuracy_algoritmos.png')
plt.close()
...
plt.savefig('grafica_score_promedio_algoritmos.png')
plt.close()
...
plt.savefig("top5_compradores.png")
plt.show()
